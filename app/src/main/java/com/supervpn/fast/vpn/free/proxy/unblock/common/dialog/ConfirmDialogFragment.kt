package com.supervpn.fast.vpn.free.proxy.unblock.common.dialog
...
class ConfirmDialogFragment : DialogFragment() {
    companion object {
        ...
        fun showMessage(context: Context, fragmentManager: FragmentManager, onPositiveClickListener: (() -> Unit)?, message: String) {
            val dialog = ConfirmDialogFragment()
                .apply {
                    this.title = context.getString(R.string.alert_dialog_title)
                    this.onPositiveClickListener = onPositiveClickListener
                    this.message = message
                    this.textPositive = context.getString(R.string.ok)
                }
            dialog.show(fragmentManager, "showMessage")
        }
        ...
        fun showRatingApp(
            ...
            onOtherClickListener: (() -> Unit)?
        ) {
            val dialog = ConfirmDialogFragment()
                .apply {
                    this.title = context.getString(R.string.rating_dialog_title)
                    this.message = context.getString(R.string.rating_dialog_message)
                    this.textPositive = context.getString(R.string.ok)
                    this.textNegative = context.getString(R.string.not_now)
                    this.textOther = context.getString(R.string.never)
                    this.onPositiveClickListener = onPositiveClickListener
    ...
    var textOther: String? = null
    private var onOtherClickListener: (() -> Unit)? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        view.tvOther.setOnClickListener { handleOther() }
        ...
        textOther?.let {
            view.tvOther.visibility = View.VISIBLE
            view.tvOther.text = it
        }
