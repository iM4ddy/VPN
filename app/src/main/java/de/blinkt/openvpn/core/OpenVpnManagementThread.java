...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    private void protectFileDescriptor(FileDescriptor fd) {
        ...
        Timber.d("Failed to retrieve fd from socket: " + fd);
        ...
        if (command.startsWith(">") && command.contains(":")) {
            ...
            switch (cmd) {
                ...
                default:
                    ...
                    Timber.i("Got unrecognized command %s", command);
                    break;
            }
            ...
            Timber.i("Got unrecognized line from managment %s", command);
        ...
        switch (needed) {
            ...
            */
            ...
            case "OPENTUN":
                ...
                break;
            default:
                Timber.e("Unknown needok command %s", argument);
                return;
        }
